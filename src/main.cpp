...
/**
 * Funkcija skirta atlikti visus reikiamus dalykus, kad programa veiktu gerai
 *
 * Sioje funkcijoje pirmaiusiai paklausiama ar vartototojas nori imti duomenis is failo ir jeigu jis paraso t, tada einama i true salyga kurioje vel klausiama ar vartotojas nori pats
 * pasirinkti faila ar, kad failas butu jau automatinis. Psirinkus, kad pats ivesti vartotojas tures ivesti failo varda ir tada bus atliekama viskas, kas reikalinga su tuo failu. Jeigu pasirinks
 * testavima, dar tures pasirinkti ar generuojami bus nauji failai ar tiesiog naudos jau esancius kompiuteryje. Kai tai atsakys bus kreipiamasi i kitas funkcijas, kad butu apdorojamas failas.
 *
 * Jeigu pirmajame klausime vartotojas atsake, kad nori duomenis ivesti ranka, tada jis tures pasirinkti pagal ka bus skaiciuojamas galutinis ivertinimas pagal vidurki ar mediana. Tai padares
 * vartotojui bus leidziama ivesti studentus tol, kol jis to nores ir pasibaigus ivedimui visi rezultatai bus apdoroti ir isvesti i ekrana.
 */
int main() {
